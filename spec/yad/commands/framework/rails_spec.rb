...
describe Yad::Commands::Framework::Rails do
  
  it "should build the setup command" do
    cmd = Yad::Commands::Framework::Rails.build_setup_command('path/to/shared/directory', :umask => '02')
  ...
  it "should build the update command" do
    cmd = Yad::Commands::Framework::Rails.build_update_command('path/to/new/release', 'path/to/shared/directory', :app_env => 'production', :framework_update_db_config_via => 'none')
  ...
  it "should build the update command with db config setup via copy" do
    cmd = Yad::Commands::Framework::Rails.build_update_command('path/to/new/release', 'path/to/shared/directory', :app_env => 'production', :framework_update_db_config_via => 'copy')
  ...
  it "should build the update command with db config setup via symlink" do
    cmd = Yad::Commands::Framework::Rails.build_update_command('path/to/new/release', 'path/to/shared/directory', :app_env => 'production', :framework_update_db_config_via => 'symlink')
